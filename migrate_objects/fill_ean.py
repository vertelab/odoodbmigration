...
#migrate_model('product.product', include=True, custom=product_product_custom, migrate_fields=product_product_include, create=False)
migrate_model('product.template', include=True, migrate_fields=product_product_include, custom=product_product_custom, domain=pp_domain, create=False)
if debug:
    input("press enter to continue")
