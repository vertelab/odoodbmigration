...
# ~ # res.partner fields to copy from source to target BROKEN(type)
...
# ~ product_product_exclude = ['message_follower_ids', 'company_id', 'attribute_value_names', 'product_variant_ids', 'virtual_available_days', 'purchase_line_warn', 'purchase_line_warn_message']
