...
print("#"*99)
"""}
variant_ids = [4295, 2983, 3485]
migrate_model('product.product', include=False, custom=product_product_custom, migrate_fields = product_product_exclude, hard_code = product_product_hardcode, create = False, domain = [('id', 'in', variant_ids)], bypass_date = True, calc = product_product_calc)
