    ...
    if kursstatus:
        if kursstatus.startswith('1') or kursstatus.startswith('2'):
            ...
            if not partly_invoiced:
                ...
                create_xmlid('event.stage', partly_invoiced, partly_invoiced_xmlid)
            ...
            if not fully_invoiced:
                ...
                create_xmlid('event.stage', fully_invoiced, fully_invoiced_xmlid)
...
maps['parent_template_xmlid'] = get_xmlid('prod_reg', vals.pop('parent_template_id'))
""",
        'after': """
...
if verksamhetsgren:
    if verksamhetsgren in ['P1109', 'P1110', 'P1111', 'P1160', 'P1180', 'P1280', 'P1370', 'P1385', 'P1395', 'P1410', 'P1420', 'P1425', 'P1430', 'P1590', 'P1601', 'P1740', 'P1751', 'P1760', 'P1790']:
        vals['property_account_income_id'] = get_res_id('account_sks.chart3332')
        ...
        'P1266', 'P1267']:
        vals['property_account_income_id'] = get_res_id('account_sks.chart3322')
""",
    },
    # endregion
    # region uppdrag.xlsx
    'uppdrag.xlsx': {
        'external_identifier' :'uppdrag',
...
if len(ext_id) == 5:
    parent_xmlid = get_xmlid('product_category', ext_id[1:3])
...
if partner_id:
    ...
    if mode == 'debug':
        ...
        create_record_and_xmlid_or_update('res.partner', partner_vals, partner_xmlid)
...
if uppdrag:
    ...
    if project_id:
        ...
        if partner:
            ...
            order_id = create_record_and_xmlid_or_update('sale.order', order_vals, order_xmlid)
            if order_id:
